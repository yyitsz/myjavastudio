...
namespace SQLiteTools.Utils
{
    ...
    public class MessageBoxHelper
    {
        ...
        {
            return Show(textResourceID, "Prompt", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1,
                param);
        }
        ...
        {
            return Show(textResourceID, "Prompt", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1,
                param);
        }
        ...
        {
            return ShowOKCancel("Prompt", textResourceID, param);
        }
        ...
        {
            return Show(textResourceID, "Prompt", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2, param);
        ...
        {
            return Show(textResourceID, "Prompt", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button3, param);
        ...
        {
            return Show(textResourceID, "Prompt", MessageBoxButtons.RetryCancel, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1, param);
        }
