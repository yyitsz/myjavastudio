 ...
 * @see #printStackTrace
 */
public class LightCommonsException extends RuntimeException {
	 ...
	 */
	public LightCommonsException(String msg) {
		super(msg);
	}

	public LightCommonsException(String msg,Object[] args) {
		super(msg);
		this.args = args;
	}
	 ...
	 */
	public LightCommonsException(String msg, Throwable cause) {
		super(msg, cause);
	}


	public LightCommonsException(String message, Object[] args, Throwable cause) {
		this(message,cause);
		this.args = args;
	}
	...
	public String getMessage() {
        ...
        if(args!=null && args.length > 0){
        	buf.append("\n arguments:").append(StringUtils.arrayToCommaDelimitedString(args));
        }
        return buf.toString();
    }
	...
	public boolean contains(Class exType) {
		...
		if (cause instanceof LightCommonsException) {
			return ((LightCommonsException) cause).contains(exType);
		}
		else {
			while (cause != null) {
