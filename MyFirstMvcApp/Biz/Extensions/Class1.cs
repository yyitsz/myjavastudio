...
{
    /// <summary>          /// Util extensions to use in your test or where you need to see the XML mappings 
    /// /// </summary>          /// <remarks>          /// You can copy&paste this source in your tests and create a test to create/see your XML mappings.          /// Mappings are created per class (each class in its XML) in a folder named "Mappings" inside the "bin" folder.          /// </remarks>         
    public static class NHibernateMappingsExtensions
    {
        ...
        {
            if (mappings == null) { throw new ArgumentNullException("mappings"); } string mappingsFolderPath = ArrangeMappingsFolderPath();
        ...
        private static string ArrangeMappingsFolderPath()
        {
            ...
            string binPath = relativeSearchPath != null ?
                ...
                : baseDir; string mappingsFolderPath = Path.Combine(binPath, "Mappings");
